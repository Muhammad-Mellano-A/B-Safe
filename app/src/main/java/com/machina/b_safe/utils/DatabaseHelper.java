...
// DatabaseHelper inilah yang akan selalu dipanggil untuk
// berinteraksi dengan tabel tertentu di dalam database baik
// untuk mengambil data, membuat data baru, mengubah, serta menghapus data.